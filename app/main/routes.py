...
from app.translate import translate, get_language_by_text
...
def home():
    ...
    if form.validate_on_submit():
        language = get_language_by_text(form.post.data)
    ...
    return render_template("home.html", title="Home Page", posts=posts.items, form=form, next_url=next_url, prev_url=prev_url)
